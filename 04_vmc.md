...
```math
J_s=\frac{1}{L_2\sin(\phi_2-\phi_3)}
\begin{bmatrix}
-\bigl[L_1\sin\phi_1 + d_1\cos(\phi_1+\alpha)\bigr]L_2\sin(\phi_2-\phi_3) - d_2 L_1 \sin(\phi_3-\phi_1)\sin\phi_2 & -d_2 L_1 (\phi_4-\phi_3) \sin\phi_2 \\
\bigl[L_1\cos\phi_1 - d_1\sin(\phi_1+\alpha)\bigr]L_2\sin(\phi_2-\phi_3) + d_2 L_1 \sin(\phi_3-\phi_1)\cos\phi_2 & d_2 L_1 (\phi_4-\phi_3) \cos\phi_2
\end{bmatrix}
```
